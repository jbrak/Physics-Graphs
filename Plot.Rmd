...
fit<- ggplotRegression(head(Data,11), "xre", "y")
...
I then went on to transform the regression line on fig.3 onto a regression line for fig.1, the result of this is shown below, clearly showing the curve that would be expected from a reciprocal relationship.
